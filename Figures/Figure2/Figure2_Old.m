...
PyrFR    = [PyrPVFR(1,~isnan(PyrPVFR(1,:))) PyrSSTFR(1,~isnan(PyrSSTFR(1,:)))];
PVFR     = PyrPVFR(2,~isnan(PyrPVFR(2,:)));
SSTFR    = PyrSSTFR(2,~isnan(PyrSSTFR(2,:)));
...
PyrPVCORR     = PyrPVCorr(~isnan(PyrPVCorr));
PyrSSTCORR    = PyrSSTCorr(~isnan(PyrSSTCorr));
