...
cd('..\..\OptoExperiments\PV-Cheta\DoubleTrans')
...
PVNonUpStates  = [3,5,7];
PVPosCtrl      = '..\..\OptoExperiments\PV-Cheta\DoubleTrans\PVOnlyS5C3_0730_.mat';
SSTPosCtrl     = '..\..\SOM-Cheta\DoubleTrans\S4C1_0519_SOMOnly.mat';
MinDuration    = 0.25;
FailMinLen     = 0.750;
...
subplot(SP2)
hold on
plot([PreUpState(1,:) StimUp(1,1:10500)],'Color',[0.1 0.1 0.1],'LineWidth',3)
plot([PreUpState(2,:) StimUp(2,1:10500)],'Color',[0.35 0.35 0.35],'LineWidth',3)
plot([PreUpState(3,:) StimUp(3,1:10500)],'Color',[0.6 0.6 0.6],'LineWidth',3)
...
line([4410 5410],[-62 -62],'Color','k','LineWidth',3)
line([5410 5410],[-62 -52],'Color','k','LineWidth',3)
text(4675,-65,'500ms','FontWeight','bold','FontSize',14)
text(5510,-52,'10mV','FontWeight','bold','FontSize',14,'Rotation',270)
...
subplot(SP1)
hold on
plot([PreUpState(1,:) NonStimUp(1,1:10500)],'Color',[0.1 0.1 0.1],'LineWidth',3)
plot([PreUpState(2,:) NonStimUp(2,1:10500)],'Color',[0.35 0.35 0.35],'LineWidth',3)
plot([PreUpState(3,:) NonStimUp(3,1:10500)],'Color',[0.6 0.6 0.6],'LineWidth',3)
...
%         NonEndStim       = mean(NonVolt(offvoltwin(1)+voltstimlen:offvoltwin(2)+voltstimlen));
        ...
        hold off
        ylim([-85 10])
        durdiff = PVMETA(i).MedPassNonStimUpDur - PVMETA(i).MedPassStimUpDur;
        title(['Duration of NonStim - Stim = ' num2str(durdiff)])
%         waitforbuttonpress
%         clf
...
%         NonEndStim       = mean(NonVolt(offvoltwin(1)+voltstimlen:offvoltwin(2)+voltstimlen));
        ...
        hold off
        ylim([-85 10])
        durdiff = SSTMETA(i).MedPassNonStimUpDur - SSTMETA(i).MedPassStimUpDur;
        title(['Duration of NonStim - Stim = ' num2str(durdiff)])
%         waitforbuttonpress
%         clf
...
if h2==1
    hold on
    line([1 2],[5 5],'LineWidth',4,'Color','k')
    text(1.4,5.3,['\ast' '\ast'],'FontWeight','bold','FontSize',20)
end
