...
subplot(SP1)
hold on
plot([PreUpState(1,:) NonStimUp(1,1:12400)],'Color',[0.1 0.1 0.1],'LineWidth',2.0)
plot([PreUpState(2,:) NonStimUp(2,1:12400)],'Color',[0.35 0.35 0.35],'LineWidth',2.0)
plot([PreUpState(3,:) NonStimUp(3,1:12400)],'Color',[0.6 0.6 0.6],'LineWidth',2.0)


line([8000 10000],[-55 -55],'Color','k','LineWidth',2.0)
line([10000 10000],[-55 -45],'Color','k','LineWidth',2.0)
text(9000,-56.2,'1s','FontWeight','bold','FontSize',12)
text(10150,-46.5,'10mV','FontWeight','bold','FontSize',12,'Rotation',270)
hold off
xlim([0 13402])
ylim([-68 -34])
box off
...
subplot(SP2)
hold on
plot([PreUpState(1,:) StimUp(1,1:12400)],'Color',[0.1 0.1 0.1],'LineWidth',2.0)
plot([PreUpState(2,:) StimUp(2,1:12400)],'Color',[0.35 0.35 0.35],'LineWidth',2.0)
plot([PreUpState(3,:) StimUp(3,1:12400)],'Color',[0.6 0.6 0.6],'LineWidth',2.0)
...
%% Panel D
clear MasterMETA
load('..\OptoUpStateData\SOM-Halo\DoubleTrans\SSTHalo2TransMETA.mat')
SSTMETA = MasterMETA;
...
if h2==1
    hold on
    line([1 2],[6.2 6.2],'LineWidth',2,'Color','k')
    text(1.25,6.5,['\ast' '\ast'],'FontWeight','bold','FontSize',16)
end
