...
PreUpState(1,:) = squeeze(MasterMETA(PVExampleCell).UpStates(1,StimInd(1)-1,12750:12950))';
PreUpState(2,:) = squeeze(MasterMETA(PVExampleCell).UpStates(1,StimInd(2)-1,12750:12950))';
PreUpState(3,:) = squeeze(MasterMETA(PVExampleCell).UpStates(1,StimInd(3)-1,12750:12950))';
ISI = 0;
...
text(4675,-63.3,'500ms','FontWeight','bold','FontSize',12)
...
PreUpState(1,:) = squeeze(MasterMETA(PVExampleCell).UpStates(1,NonStimInd(1),12750:12950))';
PreUpState(2,:) = squeeze(MasterMETA(PVExampleCell).UpStates(1,NonStimInd(2),12750:12950))';
PreUpState(3,:) = squeeze(MasterMETA(PVExampleCell).UpStates(1,NonStimInd(3),12750:12950))';
...
rectangle('Position',[800 -75 450 70],'FaceColor','none','EdgeColor','k','LineStyle','--','LineWidth',2.0);
hold off
xlim([0 8500])
ylim([-80 -30])
box off
...
hold on
for k = 1:15
    rectangle('Position',[50+ISI -100 10 100],'FaceColor',[0.5 0.7 1 0.75],'EdgeColor','none');
    ISI = ISI+30;
end
line([380 580],[-76 -76],'Color','k','LineWidth',2.0)
line([580 580],[-76 -56],'Color','k','LineWidth',2.0)
text(400,-77.5,'100ms','FontWeight','bold','FontSize',12)
text(605,-62,'20mV','FontWeight','bold','FontSize',12,'Rotation',270)
hold off
ylim([-78 -38])
box off
axis off
...
hold on
for k = 1:25
    rectangle('Position',[50+ISI -100 20 100],'FaceColor',[0.5 0.7 1 0.75],'EdgeColor','none');
    ISI = ISI+40;
end
line([600 1100],[-72 -72],'Color','k','LineWidth',2.0)
line([1100 1100],[-72 -52],'Color','k','LineWidth',2.0)
text(750,-73.5,'250ms','FontWeight','bold','FontSize',12)
text(1160,-56,'20mV','FontWeight','bold','FontSize',12,'Rotation',270)
hold off
ylim([-72 -32])
box off
axis off
